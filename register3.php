...
<div class="progress progress-striped active">
   ...
   ***************************************************************************************************************** --> 
<center>
<form class="container mtb" action="register4.php" method="POST">
  <fieldset>
    <div id="legend">
      <legend class=""><b> Step 3: Picturize your profile</b></legend>
    </div>


<br><br>
<b>1. Add a cover photo: </b><br>
<b >2. Upload your profile picture: </b> <br>
 
    </fieldset>

     <div class="controls">
        <a href="register2.php" class="btn btn-theme">Back</a>
        <a href="register4.php" class="btn btn-theme">Skip</a>
